...
var EnemyInfoComponent = (function () {
    function EnemyInfoComponent() {
    }
    __decorate([
        core_1.Input(), 
        __metadata('design:type', enemy_slot_1.EnemySlot)
    ], EnemyInfoComponent.prototype, "slot", void 0);
    EnemyInfoComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'enemy-info',
...
exports.EnemyInfoComponent = EnemyInfoComponent;
//# sourceMappingURL=enemy-info.component.js.map